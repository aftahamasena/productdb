...
<body class="bg-slate-100 font-montserrat">
    <div class="container max-w-4xl mx-auto bg-white mt-10 mb-10 rounded shadow-md">
        <div class="p-4 relative">
            <h2 class="mb-3 text-2xl font-bold text-slate-700">Form Add Product</h2>
            <!-- Tombol Back -->
            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-2">
                    ...
                    <input type="file" id="image" name="image"
                        class="block w-full mt-1 p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                ...
                <div class="mb-2">
                    ...
                    <textarea id="desc" name="desc" rows="5" placeholder="Masukkan Description Product"
                        class="block w-full mt-1 p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-500 @error('desc') border-red-500 @enderror">{{ old('desc') }}</textarea>
                ...
                <button type="submit"
                    class="mr-1 bg-blue-800 text-white px-4 py-1 rounded-lg border-2 border-blue-800 hover:bg-blue-600 hover:border-blue-600">Save</button>
                <button type="reset"
